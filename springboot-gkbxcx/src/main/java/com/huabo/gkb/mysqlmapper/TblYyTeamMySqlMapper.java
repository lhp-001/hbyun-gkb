...
@Repository
public interface TblYyTeamMySqlMapper extends MySqlMapper<TblyyTeam> {

	@SelectProvider(method = "selectAllListByStaffId" ,type = TblYyTeamMySqlConfig.class)
	@Results({
	...
	@SelectProvider(method = "selectListByStaffId" ,type = TblYyTeamMySqlConfig.class)
	@Results({
		@Result(column="teamid",property="teamid"),
		@Result(column="teamName",property="teamName"),
	})
	...
	@SelectProvider(method = "selectListInfoByPageInfo" ,type = TblYyTeamMySqlConfig.class)
	@Results({
		@Result(column="teamid",property="teamid"),
		@Result(column="teamName",property="teamName"),
	})
	...
	@SelectProvider(method = "selectCountByPageInfo" ,type = TblYyTeamMySqlConfig.class)
	...
	@Insert("INSERT INTO TBL_YY_TEAM(COMPANYID,createDate,STAFFID,teamName) VALUE (#{compay},#{createDate},#{createPeson},#{teamName})")
	void insert(TblyyTeam team) throws Exception;
