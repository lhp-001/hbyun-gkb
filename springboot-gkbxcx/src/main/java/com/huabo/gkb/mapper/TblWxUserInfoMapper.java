...
public interface TblWxUserInfoMapper extends Mapper<TblWxUserInfo> {
	...
	@Options(useGeneratedKeys=true, keyProperty="userId", keyColumn="USERID")	void insertWxUserInfoReturnUserId(TblWxUserInfo userInfo) throws Exception;
